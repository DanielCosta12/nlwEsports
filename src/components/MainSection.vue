<template>
  <main>
    <section>
      <div>
        <h2>Meus jogos</h2>
        <p>Os games que eu mais gosto de assistir</p>
        <ul class="games-list">
          <li>
            <a
            ...
            >
              <img
                src="https://static-cdn.jtvnw.net/ttv-boxart/32399_IGDB-188x250.jpg"
                alt="imagem cs:go"
              />
            </a>
          </li>
          <li>
            ...
            >
              <img
                src="https://static-cdn.jtvnw.net/ttv-boxart/743-188x250.jpg"
          ...
          <li>
            ...
            >
              <img
                src="https://static-cdn.jtvnw.net/ttv-boxart/1469308723-188x250.jpg"
                alt="imagem dev"
              />
            </a>
          </li>
          ...
          <li>
            <a href="https://www.twitch.tv/gaules" target="_blank">
              <img
                ...
                alt="imagem canal do gaules"
              />
            </a>
          </li>
          <li>
            <a href="https://www.twitch.tv/gmkrikor" target="_blank">
              <img
                src="https://static-cdn.jtvnw.net/jtv_user_pictures/9cad722a-b493-4b1d-9cca-93da0cfdcbc5-profile_image-150x150.png"
                alt="imagem canal do krikor"
              />
            </a>
          </li>
          <li>
            <a href="https://www.twitch.tv/mch_agg" target="_blank">
              <img
                src="https://static-cdn.jtvnw.net/jtv_user_pictures/dfb0cef3-87ca-4f09-9f52-7d7de319afbb-profile_image-150x150.png"
                alt="imagem canal do mch_agg"
              />
            </a>
          </li>
          <li>
            <a href="https://www.twitch.tv/gafallen" target="_blank">
              <img
                src="https://static-cdn.jtvnw.net/jtv_user_pictures/e8b0563d-a036-4bd6-bf3e-5d6b2e9300cf-profile_image-150x150.png"
                alt="imagem canal do fallen"
              />
            </a>
          </li>
          <li>
            <a href="https://www.twitch.tv/vinicin_lil" target="_blank">
              <img
                src="https://static-cdn.jtvnw.net/jtv_user_pictures/5549cdb8-4669-4430-b217-e1602a361abf-profile_image-150x150.png"
                alt="imagem canal do vinicin"
              />
            </a>
          </li>
          <li>
            <a href="https://www.twitch.tv/liminhag0d" target="_blank">
              <img
                src="https://static-cdn.jtvnw.net/jtv_user_pictures/308fa859-303d-44eb-a383-96eb6c18e78a-profile_image-70x70.png"
                alt="imagem canal do liminha"
              />
            </a>
          </li>
        </ul>
    ...
    <section>
      <div>
        ...
        <ul class="social-list">
          <li>
            <a href="https://www.twitch.tv/settings/ne_danz" target="_blank">
              <svg
                width="33"
                height="32"
                viewBox="0 0 33 32"
          ...
          <li>
            <a href="https://twitter.com/_danielcosta12" target="_blank">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <li>
            <a href="https://www.linkedin.com/ne_danz" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
          ...
          <li>
            <a href="https://discord.com/users/dan#8150" target="_blank">
              <svg
                width="124"
                height="34"
                viewBox="0 0 124 34"
